            ...
            <div class="cover-content">
                ...
                <div class="cover-image">
                    <span class="fleamarket-cover-image">
                        <img srcset="https://d1unjqcospf8gs.cloudfront.net/assets/home/main/3x/fleamarket-39d1db152a4769a6071f587fa9320b254085d726a06f61d544728b9ab3bd940a.webp "
                            alt="믿을만한 이웃 간 중고거래"
                    ...
                    <span class="fleamarket-cover-image-mobile">
                        <img srcset="https://d1unjqcospf8gs.cloudfront.net/assets/home/main/mobile/3x/fleamarket-1caf5c24c82acb20bd86fa8c018987be7812a1f0ce0858dcf175568bfc3cf87d.webp 3x"
                            alt="믿을만한 이웃 간 중고거래"
            ...
            <div>
                ...
                <div class="cards-wrap">
                    <article class="card-top" v-for="(item, i) in item" :key=i @click="detail(i)">
                        ...
                        <div class="card-region-name">{{ item.town }}</div>
                        <div class="card-counts">{{ item.content }}</div>
                        <div class="card-counts fontcol-gray font-size15">
                            <span>관심 {{ item.likeCount }}</span> ∙ <span>채팅 {{ item.chat }}</span>
                        </div>
                    </article>
                </div>
            ...
            <ul class="keywords-list">
                <li class="keyword-item text-m">
                    <a class="keyword-link" rel="nosublink"
                        href="https://www.daangn.com/search/%EB%82%98%EB%88%94">나눔</a>
                </li>
                <li class="keyword-item text-m">
                    <a class="keyword-link" rel="nosublink"
                ...
                <li class="keyword-item text-m">
                    <a class="keyword-link" rel="nosublink"
                        href="https://www.daangn.com/search/%ED%95%9C%ED%99%94">한화</a>
                </li>
                <li class="keyword-item text-m">
                    <a class="keyword-link" rel="nosublink"
                ...
                <li class="keyword-item text-m">
                    <a class="keyword-link" rel="nosublink"
                        href="https://www.daangn.com/search/%EC%B1%85%EC%83%81">책상</a>
                </li>
            </ul>
        </section>
    </main>
...
@media (min-width: 768px) {
    ...
    .fleamarket-article-list .cards-wrap .card-top,
    .fleamarket-article-list .cards-wrap .card {
        width: 223px;
        margin-bottom: 56px;
    }
}
...
@media (min-width: 768px) {
    ...
    .fleamarket-article-list .cards-wrap .card-top .card-photo,
    .fleamarket-article-list .cards-wrap .card .card-photo {
        width: 100%;
        padding-top: 100%;
        position: relative;
        overflow: hidden;
...
@media (min-width: 768px) {
    ...
    .fleamarket-article-list .cards-wrap .card-top .card-photo img,
    .fleamarket-article-list .cards-wrap .card .card-photo img {
        position: absolute;
        top: 0;
        bottom: 0;
        width: 100%;
...
@media (min-width: 768px) {
    ...
    .fleamarket-article-list .cards-wrap .card-top .card-desc,
    .fleamarket-article-list .cards-wrap .card .card-desc {
        margin-top: 12px;
    }
}
...
@media (min-width: 768px) {
    ...
    .fleamarket-article-list .cards-wrap .card-top .card-desc .card-title,
    .fleamarket-article-list .cards-wrap .card .card-desc .card-title {
        font-size: 16px;
...
@media (min-width: 768px) {
    ...
    .fleamarket-article-list .cards-wrap .card-top .card-desc .card-price,
    .fleamarket-article-list .cards-wrap .card .card-desc .card-price {
        font-size: 15px;
        font-weight: 700;
        line-height: 1.5;
        margin-bottom: 4px;
...
@media (min-width: 768px) {
    ...
    .fleamarket-article-list .cards-wrap .card-top .card-desc .card-region-name,
    .fleamarket-article-list .cards-wrap .card .card-desc .card-region-name {
        font-size: 13px;
        color: #212529;
        overflow: hidden;
        white-space: nowrap;
...
@media (min-width: 768px) {
    ...
    .fleamarket-article-list .cards-wrap .card-top .card-desc .card-counts,
    .fleamarket-article-list .cards-wrap .card .card-desc .card-counts {
        color: #868e96;
        font-size: 13px;
    }
}
