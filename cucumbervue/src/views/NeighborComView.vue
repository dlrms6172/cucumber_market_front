    ...
    <section class="store-cover">
      <div class="cover-content">
        ...
        <span class="store-cover-image">
          <img
              alt="믿을만한 이웃 간 중고거래"
              src="/images/NeighborCom/nearby_stores_hero_image_3x.47c43e04.png">
        </span>
          <span class="store-cover-image-mobile">
          <img
              alt="믿을만한 이웃 간 중고거래"
              src="/images/NeighborCom/nearby_stores_hero_image_3x.47c43e04.png">
        </span>
...
.store-cover .cover-content .cover-image {
  position: absolute;
  bottom: 0;
  display: flex;
}
...
.store-cover .cover-content .cover-image span {
  box-sizing: border-box;
  overflow: hidden;
  width: initial;
  height: initial;
...
@media (min-width: 768px) {
  .cover-image .store-cover-image {
    display: block;
  }
}

.store-cover .cover-content .cover-image span img {
  position: absolute;
  top: 0;
  left: 0;
  bottom: -76px;
...
@media (min-width: 768px) {
  .cover-image .store-cover-image img {
    display: block;
  }
}
